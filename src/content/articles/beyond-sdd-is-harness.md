---
title: SDD之外是Harness吗
description: 从提示词工程到Harness Engineering，AI编程这条线一直在做同一件事：人离代码越来越远，但对产出的控制力越来越强。OpenAI用3个工程师让Codex生成100万行代码的实践，揭示了Harness在AI编程可靠性中的决定性作用。
author: li-xuetao
date: 2026-04-08
...
和我们日常用的 Skill 系统是同一个思路：AGENTS.md 是 L1 cache，告诉 Agent 有哪些能力方向；docs/ 目录是 L2，按需加载具体文档；具体的规格文件和参考手册是 L3，只在相关任务中被读取。每一层只暴露当前决策所必需的信息。
